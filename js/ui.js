...
export function createUI({ supabase }){
  ...
  async function refreshKPIs(){
    ...
    kpis.innerHTML = `
  <div class="kpi"><div class="t">Salário base</div><div class="v">${fmtBRL(emp.monthlySalary||0)}</div></div>
  <div class="kpi"><div class="t">Horas mês</div><div class="v">${fmtMin(t.worked)}</div></div>
  <div class="kpi"><div class="t">Extras</div><div class="v">${fmtMin(t.extra)}</div></div>
  <div class="kpi"><div class="t">Valor horas</div><div class="v">${fmtBRL(t.valueHours)}</div></div>
  <div class="kpi"><div class="t">Valor extras</div><div class="v">${fmtBRL(t.valueExtra)}</div></div>
